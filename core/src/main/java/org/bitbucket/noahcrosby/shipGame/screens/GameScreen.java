...
//    }
    ...
    private void transitionNodes(MapNode nn, MapNode pn) {
        ...
        asteroidManager.setRespawingAsteroids(nn.getAsteroids() /* Empties the asteroids from the new node, to be reset later when switching nodes. */);
        nn.setAsteroids(new Array<>());
